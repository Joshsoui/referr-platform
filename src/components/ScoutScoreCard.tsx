    ...
    <Card className={compact ? "p-4" : ""}>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm font-semibold text-fk-navy/60">Scout Score</p>
          ...
          <p className="mt-2 text-sm text-fk-navy/65">
            Je Scout Score laat zien hoe betrouwbaar en waardevol jouw referrals
            zijn.
          </p>
          {!compact && (
            <div className="mt-4 grid grid-cols-2 gap-2 text-xs sm:grid-cols-4">
              <div className="rounded-lg bg-fk-light px-3 py-2">
                <p className="text-fk-navy/50">Confidence 70+</p>
          ...
          <div className="mt-4 flex gap-4 text-xs font-medium">
            <span className="text-fk-primary">XP = hoe actief je bent</span>
            <span className="text-fk-secondary">
              Scout Score = hoe goed je referrals zijn
            </span>
          </div>
        </div>
      </div>
