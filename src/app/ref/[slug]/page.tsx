        ...
        <div className="mx-auto max-w-lg text-center">
          <Card>
            ...
            <p className="mt-3 text-fk-navy/60">
              Deze introductielink is ongeldig of niet meer actief.
            </p>
            <div className="mt-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-fk-navy/60">
                  ...
                  {scout.name.split(" ")[0]} zodat de voortgang en eventuele
                  beloning goed kunnen worden gevolgd.
                </p>
              </div>
            </div>
          </Card>
        ...
        <FadeIn delay={100}>
          <div className="mb-8">
            ...
            <p className="mt-2 text-fk-navy/60">
              Ken jij iemand die past? Stuur een introductie via de link van{" "}
              <span className="font-bold text-fk-primary">{scout.name}</span> en
              help goede mensen zichtbaar maken.
            </p>
          </div>
        </FadeIn>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Waarom past deze kandidaat? Wat zoekt hij/zij?"
              ...
              <Button type="submit" loading={loading} className="w-full sm:w-auto">
                Introductie versturen via {scout.name.split(" ")[0]}
              </Button>
            </form>
          </Card>
        </FadeIn>
